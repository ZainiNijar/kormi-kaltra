...
type RegistrasiPegiatDesktopProps = {};

const RegistrasiPegiatDesktop = (props: RegistrasiPegiatDesktopProps) => {
  return (
    <>
      <VStack
        w={"full"}
...
export default RegistrasiPegiatDesktop;
