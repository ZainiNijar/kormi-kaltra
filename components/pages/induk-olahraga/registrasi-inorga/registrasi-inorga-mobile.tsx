...
type RegistrasiInorgaMobileProps = {};

const RegistrasiInorgaMobile = (props: RegistrasiInorgaMobileProps) => {
  return (
    <>
      <VStack
        w={"full"}
...
export default RegistrasiInorgaMobile;
