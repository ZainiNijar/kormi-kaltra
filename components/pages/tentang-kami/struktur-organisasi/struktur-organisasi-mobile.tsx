...
import HierarchyTreeMobile from "./hierarchy-mobile";

type StrukturOrganisasiMobileProps = {};

const StrukturOrganisasiMobile = (props: StrukturOrganisasiMobileProps) => {
    ...
    <>
      ...
      <Container py={`70px`} maxW={`container.xl`} mx={`auto`}>
        <VStack w={"full"} minH={"50vh"} mb={`50px`}>
          ...
          <Center width={`100%`}>
            {isClient ? <HierarchyTreeMobile data={data} /> : ""}
          </Center>
        </VStack>
      </Container>
    </>
...
export default StrukturOrganisasiMobile;
